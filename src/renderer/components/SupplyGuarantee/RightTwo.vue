    ...
    drawLine() {
        ...
        series: [
          {
            ...
            data: this.right_two_chart_1_Data.xdata
          }
        ]
      });
      ...
      myChart3.setOption({
        ...
        legend: {
          show: false,
          padding: [40, 0, 0, 0],
          data: this.right_two_chart_3_Data.legendData
        },
        grid: {x: '120px', width: '60%', height: '70%'},
        ...
        xAxis: {
          ...
          type: 'category',
          boundaryGap: false,
          data: this.right_two_chart_3_Data.xdata
        },
        yAxis: {
          axisLabel: {
            show: true,
        ...
        series: this.right_two_chart_3_Data.seriesData
      });
    }
  }
};
