  ...
  data() {
    return {
      ...
      toNum3: [ { name: 'toTotalNumberOfModels', value: 157 },
        { name: 'toTotalNumber', value: 132461 },
        { name: 'toStandNumber', value: 111574 }],
      line_one_Data1: {xdata: [62.7, 30, 62.7, 17.2, 39.8], ydata: ['歼击机', '轰炸机', '运输机', '无人机', '特种级']},
      line_one_Data2: {xdata: [55.1, 62.7, 17.2, 39.8], ydata: ['空空导弹', '空地导弹', '制导炸弹', '普通炸弹']},
      line_one_Data3: {xdata: [55.1, 62.7, 17.2, 39.8], ydata: ['空空导弹', '空地导弹', '制导炸弹', '普通炸弹']}
    ...
    drawLine() {
      ...
      myChart.setOption({
        ...
        yAxis: {
          ...
          data: this.line_one_Data1.ydata,
          axisLabel: {
            show: true,
            textStyle: {
              color: '#ffffff',
        ...
        series: [
          {
            ...
            data: this.line_one_Data1.xdata
          }
        ]
      });
      ...
      myChart1.setOption({
        ...
        yAxis: {
          type: 'category',
          data: this.line_one_Data2.ydata,
          axisLabel: {
            show: true,
            textStyle: {
              color: '#ffffff',
        ...
        series: [
          {
            ...
            data: this.line_one_Data2.xdata
          }
        ]
      });
      ...
      myChart2.setOption({
        ...
        yAxis: {
          type: 'category',
          data: this.line_one_Data3.ydata,
          axisLabel: {
            show: true,
            textStyle: {
              color: '#ffffff',
        ...
        series: [
          {
            ...
            data: this.line_one_Data3.xdata
          }
        ]
      });
